      ...
      <div id="cadastro">
        <form method="post" action=""> 
          ...
          <p> 
            ...
            <input id="name" name="name" required="required" type="text" placeholder="Revolução dos Bichos" />
          </p>
          
          <p> 
            <label for="author">Autor</label>
            <input id="author" name="author" required="required" type="text" placeholder="George Orwell"/> 
          </p>
          
          <p> 
            <label for="description">Descrição</label>
            <input id="description" name="description" required="required" type="text"  placeholder="Uma das principais reflexões de 1984..." maxlength="600"/>
          </p>
